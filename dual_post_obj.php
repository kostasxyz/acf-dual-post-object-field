...
class dual_Post_object extends acf_Field
{
	...
	*-------------------------------------------------------------------------------------*/
	...
	function __construct($parent)
	{
    	...
    	$this->name = 'dual_post_object';
		$this->title = __("Dual Post Object",'acf');
	...
	*-------------------------------------------------------------------------------------*/
	...
	function update_value($post_id, $field, $value)
	{
		...
		if (!empty($oValues) && !in_array($post_id, $oValues ) )
		{
			array_push($oValues, $post_id);     
			
			update_post_meta($value, 'reverse_obj', maybe_serialize($oValues));
						
		}
			
		//delete_post_meta($value, 'reverse_obj');
